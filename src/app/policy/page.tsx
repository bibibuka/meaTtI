    ...
    <div className="bg-white dark:bg-neutral-950 min-h-screen text-neutral-900 dark:text-neutral-100 font-sans py-10 sm:py-16 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none text-sm md:text-base text-neutral-600 dark:text-neutral-300 space-y-6 leading-relaxed">
          ...
          <p>
            2.1. Связаться с нами можно в Telegram (@maetti_mihail), в MAX или по телефону +7 (921) 652-74-96. Текст, который вы вводите на странице «Контакты», никуда не отправляется — он только подставляется в сообщение в Telegram, а отправляете его вы сами.
          </p>
          <p>
            2.2. Переписка ведётся в выбранном вами мессенджере и подчиняется его правилам. Сведения, которые вы сообщите нам в переписке, мы используем только чтобы ответить на ваш запрос и обсудить работу, и не передаём их третьим лицам.
          </p>
