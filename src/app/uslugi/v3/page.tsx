      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        <div className="divide-y divide-neutral-200 dark:divide-neutral-800 border-t border-b border-neutral-200 dark:border-neutral-800">
          {SECTIONS.map((sec) => {
            ...
            return (
              <div key={sec.id} className="py-6 transition-colors">
                <button
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <Icon className={`w-6 h-6 transition-colors ${isOpen ? "text-blue-600 dark:text-blue-400" : "text-neutral-400 group-hover:text-neutral-700 dark:group-hover:text-neutral-300"}`} />
                    <div>
